...
public class GuiSelectWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for( int i = 2; 100 >= i;i++)
        {
            if(GMNameList.get(i) != null || GMIDList.get(i) != null)
            {
             field_35316_k[i] = stringtranslate.translateKey(GMNameList.get(i).toString());
            }
...
//Code Start
    public void selectWorld(int i)
    {
        ...
        if(j == 1)
        {
           ...
           {
            mc.playerController = GMAPI.playerController[j];
            GMAPI.GM = j;
           }
        }
